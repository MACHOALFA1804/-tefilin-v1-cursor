      ...
      default:
        return (
          <main className="max-w-7xl mx-auto px-4 py-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-slate-400 text-lg mt-1">
                  Acompanhamento espiritual e gestão de visitantes
                </p>
              </div>
            ...
            {/* Versículo Bíblico */}
            <div className="rounded-xl border border-yellow-500/30 bg-gradient-to-r from-yellow-500/10 to-amber-500/10 shadow-lg shadow-yellow-500/10 p-6 mb-8">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-yellow-500/20 text-yellow-300 grid place-items-center flex-shrink-0">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div className="flex-1">
                  ...
                  <cite className="text-yellow-300 text-sm font-semibold mt-2 block">
                    — Colossenses 3:23
                  </cite>
                  <p className="text-slate-300 text-sm mt-3 opacity-90">
                    Que este versículo inspire cada ação pastoral realizada
                    neste sistema, lembrando que servimos ao Senhor em tudo o
                    que fazemos.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  Acompanhar o crescimento da igreja através de estatísticas
                  detalhadas dos visitantes.
                </p>
                <button
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Discipulado e visitas
                    </p>
                  </div>
                </div>
                <p className="text-slate-300 text-sm mb-4">
                  Acompanhar o desenvolvimento espiritual dos visitantes e novos
                  membros.
                </p>
                <button
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  Agendar visitas pastorais e acompanhar o histórico de
                  acompanhamento.
                </p>
                <button
                  onClick={() => setActiveView("agendamento")}
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  Gerar relatórios detalhados sobre o crescimento e
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  Enviar mensagens personalizadas e manter contato com
                  visitantes e membros.
                </p>
                <button
              ...
              <div className="rounded-xl border border-cyan-500/30 bg-slate-800/60 shadow-lg shadow-black/20 p-6 hover:bg-slate-800/80 transition-colors">
                ...
                <p className="text-slate-300 text-sm mb-4">
                  Gerenciar programação de cultos, eventos e atividades da
                  igreja.
                </p>
                <button
                  onClick={() => setActiveView("dados")}
